...
use agentzero::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use agentzero::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = agentzero::providers::ProviderRuntimeOptions::default();
