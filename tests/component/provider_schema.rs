...
use agentzero::providers::compatible::AuthStyle;
use agentzero::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use agentzero::providers::compatible::OpenAiCompatibleProvider;
