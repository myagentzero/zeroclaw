...
const SNAPSHOT_HEADER: &str = "# 🧠 AgentZero Memory Snapshot\n\n\
    > Auto-generated by AgentZero. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 AgentZero Memory Snapshot

> Auto-generated by AgentZero.
...
I am AgentZero, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 AgentZero Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
