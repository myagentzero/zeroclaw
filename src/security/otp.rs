...
const OTP_ISSUER: &str = "AgentZero";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(agentzero_dir);
...
pub fn secret_file_path(agentzero_dir: &Path) -> PathBuf {
    agentzero_dir.join(OTP_SECRET_FILE)
}
