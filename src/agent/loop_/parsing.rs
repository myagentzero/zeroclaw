...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/agentzero/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to AgentZero tool names.
...
/// to. This function encodes the mapping for known AgentZero tools.
...
pub(super) fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. AgentZero tool-call tags (<tool_call>, <toolcall>, <tool-call>)
