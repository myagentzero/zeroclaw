...
AgentZero supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current AgentZero provider behavior.

## Overview

AgentZero supports these Z.AI aliases and endpoints out of the box:
...
### Test with AgentZero CLI

```bash
# Test agent directly
echo "Hello" | agentzero agent
