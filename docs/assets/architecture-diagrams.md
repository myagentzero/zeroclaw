# AgentZero Architecture Diagrams

This document provides visual representations of AgentZero's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways AgentZero can be run:**

```mermaid
flowchart TD
    Start[agentzero CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[agentzero daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[AgentZero Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>AGENTZERO_* env vars]
...
*Generated for AgentZero v0.1.0 - Architecture Documentation*
