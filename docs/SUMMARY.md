...
- [consolidation-integration.md](consolidation-integration.md) — memory consolidation architecture
...
- [adr-004-tool-shared-state-ownership.md](architecture/adr-004-tool-shared-state-ownership.md)
- [consolidation-integration.md](consolidation-integration.md)
