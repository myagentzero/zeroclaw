# AgentZero ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for AgentZero edge scenarios on ESP32.
...
3. Connect UI state with AgentZero edge/runtime messaging
...
- [AgentZero Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
