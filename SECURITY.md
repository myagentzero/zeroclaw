...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/myagentzero/agentzero/security/advisories/new)
...
AgentZero implements defense-in-depth security:
...
AgentZero Docker images follow CIS Docker Benchmark best practices:
...
docker inspect --format='{{.Config.User}}' agentzero
# Expected: 65534:65534

# Run with read-only filesystem (production hardening)
docker run --read-only -v /path/to/workspace:/workspace agentzero gateway
```
